"""Training loop for the trainable-embeddings variant."""
...
def train():
    ...
    model = SmallestAdditionTransformerTrainable().to(device)
    ...
    if use_wandb:
        wandb.init(
            ...
            config={
                ...
                "embeddings": "trainable_spiral_init",
            },
        )
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_exact_acc > best_exact_acc:
            ...
            best_epoch = epoch
            patience_counter = 0
            torch.save(model.state_dict(), 'best_model_trainable_emb.pt')
        else:
            patience_counter += 1
